...
$document.ready(function () {
  ...
  if (plugins.rdGoogleMaps.length) {
    ...
    $.getScript("//maps.google.com/maps/api/js?key=AIzaSyCzKS77ldHIk21jRdIvSJKMW_fJd6Vz_Ec&sensor=false&libraries=geometry,places&v=3.7", function () {
